    ...
    p.draw = function() {
        ...
        for (var r = 0; r < p.rows.length; r++) {
            ...
            //if (p.rows[r].getNum("Sec_Before_Goal") >= -p.value) {
              ...
              if (p.rows[r].getString("Event_Team")=="England") {
...
//var myp5 = new p5(sketch, window.document.getElementById('myRange'));
//var myp5_2 = new p5(sketch, window.document.getElementById('myRange2'));
//myp5.range = "myRange";
//myp5_2.range = "myRange2";
...
myp5.input_data = "CroatiaEngland_goal01_trippier.csv";
myp5_2.input_data = "CroatiaEngland_goal02_perisic.csv";
myp5_3.input_data = "CroatiaEngland_goal03_mandzukic.csv";
